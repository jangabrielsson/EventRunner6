...
function ER.customDefs(er)
  ...
  local function nodePost(event,cb)
    ...
    event._IP = "192.168.1.89" --fibaro.getIPaddress()
    local noderedURL = var.noderedURL
    assert(noderedURL,"noderedURL not defined")
    local params =  {
      options = {
        headers = {['Accept']='application/json',['Content-Type']='application/json', 
        ['Authorization']=basicAuthorization("jgab","Dani0961!") 
        --'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJmNzk0MjA2MzZmYzA0MTMwODBjMmRlNWIzNTFlYzY3NCIsImlhdCI6MTc1ODIyODM0NSwiZXhwIjoyMDczNTg4MzQ1fQ.d2rHpy5Ceb3ttmCVO3dDwfQVgbalA9_mNETbVctwqho'
      },
  ...
  var.nr = { post = ER.ASYNCFUN(nodered), post_as = ER.ASYNCFUN(nodered_as) }
