...
function QuickApp:main(er)
  ...
  api.post("/globalVariables",{name="Bar",value=""})
  T1 = {a={b=42}}
  T2 = {2,3,4,5}
  ...
  MyObject = {}
  er.definePropClass("MyObject")
  function MyObject:__init() PropObject.__init(self) self.props = { value=true } end
  function MyObject.getProp.value(obj) return obj.props.value end
  function MyObject.setProp.value(obj,prop,value) obj.props.value=value; return value end
  ...
  local stdTests = {
    ...
    -- "local bb = 2; local j = {3,[bb]=4,5}; return j",{ {3,4,5} },nil,
  ...
  local t0 = os.clock()
  er.eval("a=0; for i=1,100000 do a=a+1 end",{cont=function() print("Time for 10,000 empty loops:", os.clock()-t0) end})
